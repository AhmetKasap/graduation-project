...
# Kamera aç canlı görüntü üzerinden, arabadaki plakayı algıla, plakadan plaka bilgisini çıkart. ()
...
plaque = plaque_location(img) #x,y,w,h
x,y,w,h = plaque
if(w>h):
...
plt.imshow(img)
cv2.imwrite('dddd.png', img)
plt.show()
 

import pytesseract

imgg = cv2.imread('dddd.png')
